	    	...
	    	<div class="col-md-3">
					...
					<div class="panel panel-default">
						<div class="panel-body">
							...
							<hr>
							<div id="qtd_tweets" class="col-md-6">
								TWEETS <br> <!--<?=$qtde_tweets?>-->
							</div>
							<div id="qtd_seguidores" class="col-md-6">
					...
					<div class="panel panel-default">
						<div class="panel-body">
							<form id="form_tweet" class="input-group">
								<input id="texto_tweet" name="texto_tweet" type="text" class = "form-control" placeholder="O que está acontecendo agora?" maxlength="140"/>
